...
sudo pkill python
```
* Control the robot using the android app (listed in the software section below). When you open the app, press on "connect", choose "mrYellow". The bluetooth password is:
```
1234
```
####Updating the files
